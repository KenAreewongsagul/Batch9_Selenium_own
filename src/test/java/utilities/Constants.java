...
public class Constants {
	...
	public static final String CONFIGURATION_FILEPATH = System.getProperty("user.dir")
			+ "src/test/resources/dataFolder/cofig.properties";
	
	
	public static final String CONFIGURATION_excelPath = System.getProperty("user.dir")+"src/test/resources/dataFolder/Data.xlsx";
